...
# Load buggy solution
spec_sol = importlib.util.spec_from_file_location("make_palindrome_buggy_module", r"D:\Umass\Semester_3\cs520\exercises\exercise_2\results\make_palindrome_buggy.py")
...
def run_additional_tests(func):
    try:
        ...
        return (0, 1)
def test_make_palindrome_buggy():
