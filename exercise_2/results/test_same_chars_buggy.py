...
# Load buggy solution
spec_sol = importlib.util.spec_from_file_location("same_chars_buggy_module", r"D:\Umass\Semester_3\cs520\exercises\exercise_2\results\same_chars_buggy.py")
